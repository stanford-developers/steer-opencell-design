...
class TestFlatJellyRoll(unittest.TestCase):
    def setUp(self):
        ...
        # construct the stack
        self.flat_jelly_roll = FlatJellyRoll(
            anode=anode,
            cathode=cathode,
            separator=separator,
            focal_length=100.0,
...
class TestCylindricalJellyRoll(unittest.TestCase):
    def setUp(self):
        ...
        # construct the stack
        self.cylindrical_jelly_roll = CylindricalJellyRoll(
            anode=anode,
            cathode=cathode,
            separator=separator,
    ...
    def test_attributes(self):
        ...
        self.assertEqual(
            self.cylindrical_jelly_roll.cost_breakdown,
            {"Cathode": 1.46, "Anode": 1.03, "Separator": 0.59},
        )
        self.assertEqual(
            self.cylindrical_jelly_roll.mass_breakdown,
            {"Cathode": 130.32, "Anode": 79.0, "Separator": 4.22},
        )
