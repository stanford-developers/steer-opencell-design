...
class CasingSheetMetal():
    ...
    def __init__(self, 
        ...
        """
        CasingSheetMetal object for a cell
        :param thickness: float: thickness of the sheet metal in mm
        :param areal_cost: float: areal cost of the sheet metal in $/m^2
        :param density: float: density of the sheet metal in g/cm^3
        :param name: str: name of the sheet metal
        """
