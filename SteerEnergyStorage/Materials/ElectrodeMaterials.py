...
class Binder(Material):
    ...
    def __init__(self, name: str, specific_cost: float = None, density: float = 1.7):
        """
        ...
        :param density: float: density of the material in g/cm^3
        """
        super().__init__(name, formula=None, specific_cost=specific_cost)
        self._density = density
...
class ConductiveAdditive(Material):
    ...
    def __init__(self, name: str, specific_cost: float = None, density: float = 2.0):
        """
