...
CATHODE_ACTIVE_MATERIALS = dm.get_cathode_materials(most_recent=True)['name'].tolist()
ANODE_ACTIVE_MATERIALS = dm.get_anode_materials(most_recent=True)['name'].tolist()
