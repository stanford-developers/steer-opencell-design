...
def get_slider_configs_from_material_dict(
        material_dict: Dict[CathodeMaterial | AnodeMaterial | Binder | ConductiveAdditive, float]
    ):
...
def get_formulation_response(
    ...
    return dropdown_values_response, weight_fractions_response, flattened_slider_responses
...
def handle_cell_store_update_materials(
    ...
    dropdown_values_response, weight_fractions_response, flattened_slider_responses = get_formulation_response(
        formulation,
        n_active_div,
        n_binder_div,
        n_conductive_div
