...
def update_layup_plots(
    ...
    if relayout_data:
        ...
        if 'xaxis.range[0]' in relayout_data and 'xaxis.range[1]' in relayout_data:
            layout_updates['xaxis_range'] = [relayout_data['xaxis.range[0]'], relayout_data['xaxis.range[1]']]
        elif 'xaxis.range' in relayout_data:
            layout_updates['xaxis_range'] = relayout_data['xaxis.range']
            
        # Preserve y-axis range  
        if 'yaxis.range[0]' in relayout_data and 'yaxis.range[1]' in relayout_data:
            layout_updates['yaxis_range'] = [relayout_data['yaxis.range[0]'], relayout_data['yaxis.range[1]']]
