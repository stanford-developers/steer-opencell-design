...
def handle_property_update(
    ...
    with capture_warnings(existing_warnings, source=source, clear_source_warnings=True) as warnings_list:
        ...
        value = determine_value(config, subtype, property_name, input_values, 
                                slider_values, range_slider_values, input_start_values, 
                                input_end_values, radioitem_values, text_item_values)
